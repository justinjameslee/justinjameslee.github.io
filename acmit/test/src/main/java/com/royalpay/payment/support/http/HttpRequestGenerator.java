package com.royalpay.payment.support.http;
...
public final class HttpRequestGenerator {
    ...
    private List<NameValuePair> queryStringParams = new ArrayList<>();
    ...
    public HttpRequestGenerator setJSONEntity(Object entity) {
        ...
        currentEntity = new StringEntity(JSON.toJSONString(entity, SerializerFeature.DisableCircularReferenceDetect), ContentType.APPLICATION_JSON);
        return this;
    }
    ...
    private HttpClient buildHttpClient() {
        ...
        return HttpClientBuilder.create().setMaxConnTotal(200).setDefaultRequestConfig(config)
                .setDefaultConnectionConfig(connCfg).setDefaultCookieStore(cookieStore)
                .build();
    }
    ...
    public class PikachuFileEntity {
        ...
        public PikachuFileEntity attachFile(String fileParamKey, String fileName, byte[] fileBytes) {
            builder.addBinaryBody(fileParamKey, fileBytes, ContentType.DEFAULT_BINARY, new String(fileName.getBytes(Consts.UTF_8), Consts.ISO_8859_1));
            return this;
        }

        public PikachuFileEntity attachFile(String fileParamKey, ContentType contentType, String fileName, byte[] fileBytes) {
            builder.addBinaryBody(fileParamKey, fileBytes, contentType, new String(fileName.getBytes(Consts.UTF_8), Consts.ISO_8859_1));
            return this;
        }

        public PikachuFileEntity attachFile(String fileParamKey, String fileName, InputStream fileInputStream) {
            builder.addBinaryBody(fileParamKey, fileInputStream, ContentType.DEFAULT_BINARY, new String(fileName.getBytes(Consts.UTF_8), Consts.ISO_8859_1));
            return this;
        }

        public PikachuFileEntity attachFile(String fileParamKey, ContentType contentType, String fileName, InputStream fileInputStream) {
            builder.addBinaryBody(fileParamKey, fileInputStream, contentType, new String(fileName.getBytes(Consts.UTF_8), Consts.ISO_8859_1));
            return this;
        }
